...
import space.jonhy.app.gossip.presenter.JellyInterpolator;
...
public class PreciseLocationActivity extends AppCompatActivity {
    ...
    private void bindListener() {
        ...
        mPbLocating.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showTip(getString(R.string.precise_positioning), View.GONE);
    ...
    private void inputAnimator(final View view, float w, float h) {
        ...
        set.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                showTip(getString(R.string.finish_shuttle), View.VISIBLE);
